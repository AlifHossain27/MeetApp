...
import 'package:meet/widgets/meeting_option.dart';
      ...
      appBar: AppBar(
        ...
        body: Column(
          children: [
            ...
            const SizedBox(height:20),
            MeetingOption(text: 'Audio Turned Off', isMute: isAudioMuted, onChange: onAudioMuted),
            MeetingOption(text: 'Video Turned Off', isMute: isVideoMuted, onChange: onVideoMuted),
